...
(cl:defmethod cl:initialize-instance :after ((m <SrvTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pick_place-srv:<SrvTransform-request> is deprecated: use pick_place-srv:SrvTransform-request instead.")))

(cl:ensure-generic-function 'origin-val :lambda-list '(m))
(cl:defmethod origin-val ((m <SrvTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pick_place-srv:origin-val is deprecated.  Use pick_place-srv:origin instead.")
  (origin m))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <SrvTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pick_place-srv:target-val is deprecated.  Use pick_place-srv:target instead.")
  (target m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTransform-request>)))
  ...
  "pick_place/SrvTransformRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTransform-request)))
  "Returns string type for a service object of type 'SrvTransform-request"
  "pick_place/SrvTransformRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pick_place-srv:<SrvTransform-response> is deprecated: use pick_place-srv:SrvTransform-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SrvTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pick_place-srv:result-val is deprecated.  Use pick_place-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTransform-response>)))
  ...
  "pick_place/SrvTransformResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTransform-response)))
  "Returns string type for a service object of type 'SrvTransform-response"
  "pick_place/SrvTransformResponse")
